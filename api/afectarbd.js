...
consultadb().transaction(creartb, errorCB, successCB);
	...
	alert('entra a funcion iniciar');
		function creartb(tx) {
		 ...
		 tx.executeSql('CREATE TABLE IF NOT EXISTS ARTICULO (id INTEGER PRIMARY KEY AUTOINCREMENT, articulo TEXT NOT NULL,descripcion TEXT NOT NULL,clas TEXT NOT NULL,accion TEXT NOT NULL,precio,descuento)'); 
...
function insertar(){
        ...
        tx.executeSql('INSERT INTO CLIENTES (nombre,clave,dia,direccion,telefono,tipo,diasc,lcredito,saldo) VALUES ("Farmacia CUATRO", "1050","Jueves","Dirección del cliente  CUATRO","2281545130","C","30","50000.00","8000.00")'); 
		 ...
		 tx.executeSql('INSERT INTO erpadmin_alcxc_pen_cob (cod_zon,cod_tip_dc,num_doc,cod_clt,saldo,monto,fec_doc_ft,fec_ven,vencida) VALUES ("S04", "1","00041536","1030","5000.00","5000.00","08/06/2013","08/06/2013","N")');        
 		 tx.executeSql('INSERT INTO ARTICULO (articulo,descripcion,precio,descuento) VALUES ("ADE-01","ADEROGYL 15 SOL. C/5 AMP","OFERTA","ANTIDEA",100,30)'); 
		 tx.executeSql('INSERT INTO ARTICULO (articulo,descripcion,precio,descuento) VALUES ("ADE-01","ADEROGYL 15 SOL. C/5 AMP","OFERTA","ANTIDEA",100,30),("AGU-01","AGUA OXIGENADA CON 100 ML.","CATALOGO","ANTIGRIPAL",50,30)'); 
		 tx.executeSql('INSERT INTO ARTICULO (articulo,descripcion,precio,descuento) VALUES ("ADE-01","ADEROGYL 15 SOL. C/5 AMP","OFERTA","ANTIDEA",100,30),("AGU-01","AGUA OXIGENADA CON 100 ML.","CATALOGO","ANTIGRIPAL",40,30)'); 
